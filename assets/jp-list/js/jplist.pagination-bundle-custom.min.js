...
m=a.$control.attr("data-last-title")||a.options.lastArrowTitle;a.$control.html('<div class="jplist-pagingprev btn-group" data-type="pagingprev"></div><div class="jplist-pagingmid" data-type="pagingmid"></div><div class="jplist-pagingnext btn-group" data-type="pagingnext"></div>');a.$pagingprev=a.$control.find('[data-type="pagingprev"]');a.$pagingmid=a.$control.find('[data-type="pagingmid"]');a.$pagingnext=a.$control.find('[data-type="pagingnext"]');a.$pagingprev.html('<button type="button" class="jplist-first btn btn-sm btn-primary" data-number="0" data-type="first" title="'+
k+'">'+g+'</button><button type="button" class="jplist-prev btn btn-sm btn-primary" data-type="prev" title="'+c+'">'+f+"</button>");a.$pagingnext.html('<button type="button" class="jplist-next btn btn-sm btn-primary" data-type="next" title="'+e+'">'+h+'</button><button type="button" class="jplist-last btn btn-sm btn-primary" data-type="last" title="'+m+'">'+l+"</button>");a.$jplistFirst=a.$pagingprev.find('[data-type="first"]');a.$jplistPrev=a.$pagingprev.find('[data-type="prev"]');a.$jplistNext=a.$pagingnext.find('[data-type="next"]');a.$jplistLast=a.$pagingnext.find('[data-type="last"]');
return jQuery.extend(this,a)};g.prototype.build=function(d){if(0<=d.currentPage&&d.currentPage<d.pagesNumber){this.$control.removeClass("d-none");switch(this.mode){case "google-like":var b="",a;a=Number(this.$control.attr("data-range"))||this.options.range;b=d.currentPage-Math.floor((a-1)/2);0>b&&(b=0);a=b+a;a>d.pagesNumber&&(a=d.pagesNumber);b=e(this,b,a,d.currentPage);this.$pagingmid.html(b);break;default:var f;f=Number(this.$control.attr("data-range"))||this.options.range;a=Math.floor(d.currentPage/
f);b=f*(a+1);b>d.pagesNumber&&(b=d.pagesNumber);b=e(this,f*a,b,d.currentPage);this.$pagingmid.html(b)}this.$jplistPrev.attr("data-number",d.prevPage).removeClass("jplist-current");this.$jplistNext.attr("data-number",d.nextPage).removeClass("jplist-current");this.$jplistLast.attr("data-number",d.pagesNumber-1).removeClass("jplist-current");1>=d.pagesNumber?this.$control.addClass("jplist-one-page"):this.$control.removeClass("jplist-one-page")}else this.$control.addClass("d-none");0===d.currentPage?
this.$pagingprev.addClass("d-none"):this.$pagingprev.removeClass("d-none");d.currentPage==d.pagesNumber-1?this.$pagingnext.addClass("d-none"):this.$pagingnext.removeClass("d-none")};jQuery.fn.jplist.controls.PaginationView=function(d,b){return new g(d,b)};jQuery.fn.jplist.controlTypes.pagination={className:"Pagination",options:{range:7,jumpToStart:!1,prevArrow:"&lsaquo;",nextArrow:"&rsaquo;",firstArrow:"&laquo;",lastArrow:"&raquo;",prevArrowTitle:"",nextArrowTitle:"",firstArrowTitle:"",
