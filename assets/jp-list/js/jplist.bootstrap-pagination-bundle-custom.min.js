...
function(a,b){var c;if(jQuery.isArray(a))for(var d=0;d<a.length;d++)a[d].data&&(c=a[d].data.paging);else a.data&&(c=a.data.paging);c&&this.params.view.build(c)};jQuery.fn.jplist.controls.BootstrapPagination=function(a){return new g(a)};jQuery.fn.jplist.controlTypes["boot-pagination"]={className:"BootstrapPagination",options:{range:7,jumpToStart:!1,prevArrow:"&lsaquo;",nextArrow:"&rsaquo;",firstArrow:"&laquo;",lastArrow:"&raquo;"}}})();(function(){jQuery.fn.jplist.controls.BootstrapPaginationDTO=function(f,e){var g={currentPage:f,paging:null};e&&(g.number=e);return g}})();(function(){var f=function(a,b,c,d){var e="";a.$control.find('[data-type="page"]').remove();for(var f=b;f<c;f++)e+='<li class=" btn btn-sm btn-primary" data-type="page" ',f===d&&(e+=' class="jplist-current active" data-active="true" '),b=f+1,e+=' data-number="'+f+'" ',e+='><a class="text-white" href="#">'+b+"</a></li>";a.$jplistPrev.after(e)},e=function(a){a.$control.on("click","a",function(b){b.preventDefault()})},g=function(a,b){var c={$control:a,options:b,$jplistFirst:null,$jplistPrev:null,$jplistNext:null,$jplistLast:null,mode:a.attr("data-mode")},
d,f,g,h;d=c.$control.attr("data-prev")||c.options.prevArrow;f=c.$control.attr("data-next")||c.options.nextArrow;g=c.$control.attr("data-first")||c.options.firstArrow;h=c.$control.attr("data-last")||c.options.lastArrow;d=""+('<li class="jplist-first  btn btn-sm btn-primary" data-number="0" data-type="first"><a href="#"><span class="text-white" aria-hidden="true">'+g+'</span><span class="sr-only">First</span></a></li>')+('<li class="jplist-prev btn btn-sm btn-primary" data-type="prev"><a href="#"><span class="text-white" aria-hidden="true">'+d+'</span><span class="sr-only">Previous</span></a></li>');
d+='<li class="jplist-next  btn btn-sm btn-primary" data-type="next"><a href="#"><span class="text-white" aria-hidden="true">'+f+'</span><span class="sr-only">Next</span></a></li>';d+='<li class="jplist-last  btn btn-sm btn-primary" data-type="last"><a href="#"><span class="text-white" aria-hidden="true">'+h+'</span><span class="sr-only">Last</span></a></li>';c.$control.append(d);c.$jplistFirst=c.$control.find('[data-type="first"]');c.$jplistPrev=c.$control.find('[data-type="prev"]');c.$jplistNext=c.$control.find('[data-type="next"]');c.$jplistLast=c.$control.find('[data-type="last"]');
